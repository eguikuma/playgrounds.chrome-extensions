...
export class Overlay extends EntryComponent {
  ...
  static async start() {
    ...
    const GmailShieldOverlay = document.createElement('div');
    GmailShieldOverlay.className = `gmail-shield-overlay ${
      theme === Themes.Dark ? 'dark-mode' : 'light-mode'
    } ${enabled ? 'gmail-shield-overlay-active' : 'gmail-shield-overlay-inactive'}`;

    document.documentElement.appendChild(GmailShieldOverlay);

    this._element = GmailShieldOverlay;
  ...
  static async close() {
    ...
    this._element.classList.remove('gmail-shield-overlay-active');
    this._element.classList.add('gmail-shield-overlay-inactive');
  ...
  static async active() {
    ...
    this._element.classList.remove('gmail-shield-overlay-inactive');
    this._element.classList.add('gmail-shield-overlay-active');
